...
import com.hw3.model.vo.Product_T;

public class Run_T {

	public static void main(String[] args) {
		// 초기 값을 부여한 두 개의 객체 생성
		Product_T obj1 = new Product_T("Samsung", "Galaxy S9", "Blue", 960000);
		Product_T obj2 = new Product_T("LG", "G6", "Red", 820000);
